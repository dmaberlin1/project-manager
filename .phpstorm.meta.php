...
namespace PHPSTORM_META {
    ...
    */
    override(new \Illuminate\Contracts\Container\Container, map([
        '' => '@',
            'App\Services\Interfaces\GitHubInterface' => \App\Services\GitHubService::class,
            'App\Services\Interfaces\MailInterface' => \App\Services\MailService::class,
            'App\Services\Interfaces\StatisticsInterface' => \App\Services\StatisticsService::class,
            'App\Services\Interfaces\WeatherMapInterface' => \App\Services\OpenWeatherMapService::class,
    ...
    override(\config(), map([
            ...
            'filesystems.links./home/dmaberlin/php/practice/test/project-manager/public/storage' => 'string',
            'horizon.domain' => 'NULL',
            'horizon.path' => 'string',
            'horizon.use' => 'string',
            ...
            'logging.channels.http.driver' => 'string',
            'logging.channels.http.path' => 'string',
            'logging.channels.http.level' => 'string',
            ...
            'services.openweather.api_key' => 'string',
            'services.openweather.url' => 'string',
            'services.github.token' => 'string',
            'services.github.url' => 'string',
...
'filesystems.disks.s3.endpoint','filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links./home/dmaberlin/php/practice/test/project-manager/public/storage',
...
'logging.channels.emergency.path','logging.channels.http.driver','logging.channels.http.path','logging.channels.http.level','logging.channels.api.driver',
'logging.channels.api.path','logging.channels.api.level','logging.channels.api.days','mail.default','mail.mailers.smtp.transport',
...
'services.openweather.api_key','services.openweather.url','services.github.token','services.github.url','session.driver',
...
'passport.personal_access_client.id','passport.personal_access_client.secret','ide-helper.filename','ide-helper.models_filename','ide-helper.meta_filename',
...
'horizon.jobs.show','horizon.index','passport.token','passport.authorizations.authorize','passport.token.refresh',
'passport.authorizations.approve','passport.authorizations.deny','passport.tokens.index','passport.tokens.destroy','passport.clients.index',
'passport.clients.store','passport.clients.update','passport.clients.destroy','passport.scopes.index','passport.personal.tokens.index',
'passport.personal.tokens.store','passport.personal.tokens.destroy','sanctum.csrf-cookie','telescope','api.auth.register','api.auth.login','api.password.email',
'api.password.update','api.auth.logout','projects.index','projects.store',
'projects.show','projects.update','projects.destroy','tasks.index','tasks.store',
'tasks.show','tasks.update','tasks.destroy','auth.register','auth.register.submit','auth.login',
'auth.login.submit','auth.logout','password.reset','password.email','password.update',
'password.confirm','password.confirm.submit','password.verify','tasks.index',
'tasks.create','tasks.store','tasks.show','tasks.edit','tasks.update',
'tasks.destroy','storage.local',);
        registerArgumentsSet('views', 
'api-data','app','auth.login','auth.passwords.confirm','auth.passwords.email',
'auth.passwords.reset','auth.passwords.verify','auth.register','auth.verify','dashboard',
'emails.notification','layouts.app','notifications','projects.create','projects.edit',
'projects.index','projects.show','tasks.create','tasks.edit','tasks.index',
'tasks.show','horizon::layout','laravel-exceptions-renderer::components.card','laravel-exceptions-renderer::components.context','laravel-exceptions-renderer::components.editor',
...
'pagination::simple-tailwind','pagination::tailwind','passport::authorize','telescope::layout',);
...
'CACHE_PREFIX','CACHE_DRIVER','MEMCACHED_HOST','REDIS_CLIENT','REDIS_HOST',
'REDIS_PORT','REDIS_PASSWORD','REDIS_USER','REDIS_USER_PASSWORD','QUEUE_CONNECTION',
...
'PUSHER_APP_KEY','PUSHER_APP_SECRET','PUSHER_APP_CLUSTER','BROADCAST_DRIVER','OPENWEATHERMAP_API_KEY',
'OPENWEATHERMAP_API_URL','GITHUB_PERSONAL_ACCESS_TOKEN','GITHUB_PERSONAL_URL',);
