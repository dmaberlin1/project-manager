...
// 📥 Экспорт задач
            Route::get('/tasks/export/csv/{projectId}', [StatisticsController::class, 'exportCsv'])->whereNumber('projectId');
            Route::get('/tasks/export/json/{projectId}', [StatisticsController::class, 'exportJson'])->whereNumber('projectId');
        });
